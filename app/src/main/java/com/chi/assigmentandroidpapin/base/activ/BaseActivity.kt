...
import com.chi.assigmentandroidpapin.base.BaseAlertDialog
import com.chi.assigmentandroidpapin.core.ApiProvider
import com.chi.assigmentandroidpapin.net.NoInternetCallback
import com.chi.assigmentandroidpapin.base.LoadingDialog
import com.chi.assigmentandroidpapin.utils.NetworkChangeReceiver
...
abstract class BaseActivity<T : BasePresenter<V>, V : BaseView> : AppCompatActivity(),
    ...
    private val provider: ApiProvider by lazy { this.applicationContext as ApiProvider }
    ...
    private fun buildAlertDialog(message: String, isNeedNegativeButton: Boolean) {
        val builder = BaseAlertDialog.Builder(this, R.color.accent_material_dark)
            .setMessage(message)
